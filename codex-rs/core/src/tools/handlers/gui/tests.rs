...
fn scroll_delta_components_match_understudy_scroll_direction_convention() {
    assert_eq!(scroll_delta_components(ScrollDirection::Down, 240), (0, -240));
    assert_eq!(scroll_delta_components(ScrollDirection::Up, 240), (0, 240));
    assert_eq!(scroll_delta_components(ScrollDirection::Left, 240), (-240, 0));
    assert_eq!(scroll_delta_components(ScrollDirection::Right, 240), (240, 0));
}
